...
HD_PWD='C:/Users/dhruv/Documents/Final_Assignment_1/Final_Assignment_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parity_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parity_unit.tcl -notrace
