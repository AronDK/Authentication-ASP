...
HD_PWD='C:/Users/dhruv/Documents/Final_Assignment_1/Final_Assignment_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parity_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parity_unit.tcl
